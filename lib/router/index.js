...
function Router(options) {
  ...
  Object.defineProperty(self, 'case_senstive', {
    get: function() {
      return self.options.case_senstive;
    },
    set: function(val) {
      self.options.case_senstive = val;
    }
  });

  Object.defineProperty(self, 'strict', {
    get: function() {
      return self.options.strict;
    },
    set: function(val) {
      self.options.strict = val;
    }
  });
}
...
Router.prototype._route = function(method, path, callbacks){
  ...
  var route = new Route(method, path, callbacks, {
      sensitive: options.case_senstive
...
// add HTTP methods as prototype methods for route setting
methods.forEach(function(method){
  Router.prototype[method] = function(path) {

    // if only a path is specified, return the previous route
    if (1 === arguments.length) {
        return this.lookup(method, path);
    }

    var args = [method].concat(toArray(arguments));
    return this._route.apply(this, args);
  }
});
